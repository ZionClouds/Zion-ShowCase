...
import zionLogo from '../assets/icons/zion ai gradient-01.png'; // Replace with actual path to logo
  ...
  return (
    <AppBar position="static" sx={{ background: 'white' }}>
      <Toolbar>
        {/* Mobile Burger Menu */}
        <IconButton
          color="linear-gradient(45deg, #205BF3, #89CDA9)"
          aria-label="menu"
          sx={{ mr: 2 }}
        ...
        >
          <MenuItem onClick={handleMobileMenuClose}>
            <Link to="/profile" style={{ textDecoration: 'none', color: 'linear-gradient(45deg, #205BF3, #89CDA9)' }}>Profile</Link>
          </MenuItem>
          <MenuItem onClick={handleMobileMenuClose}>
            <Link to="/help" style={{ textDecoration: 'none', color: 'linear-gradient(45deg, #205BF3, #89CDA9)' }}>Help</Link>
          </MenuItem>
        </Menu>
