        ...
        <div className="bg-gray-50 min-h-screen text-gray-800">
            ...
            <header className="bg-blue-900 text-white py-16 text-center hero">
                ...
                <div className="flex justify-center gap-4 hero-text " style={{ display: "flex", justifyContent: "center" }}>
                    <Button style={{ color: "black", backgroundColor: "white", padding: "12px 24px", borderRadius: "32px", fontSize: "16px", margin: "12px" }} onClick={() => setOpen(true)}>
                    ...
                    <VideoDialog open={open} handleClose={() => setOpen(false)} videoUrl={videoUrl} />
                </div>
            </header>
            ...
            <section className="bg-gradient-to-r from-blue-700 to-purple-700 text-white py-16 devops">
                <div className="mx-auto flex items-center px-4 gap-6 justify-center text-center devops-inner">
                    <div className="devops-text">
                        ...
                        <Button style={{ color: "black", backgroundColor: "white", padding: "12px 24px", borderRadius: "32px", fontSize: "20px", margin: "12px" }} onClick={() => setOpen(true)}>
                            <Play style={{ fontSize: "16px", margin: "6px" }} />
                            Watch Demo
                        </Button>
                    </div>
